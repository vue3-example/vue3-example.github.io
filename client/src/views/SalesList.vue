            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr :key="i" v-for="(product, i) in productList">
                        <td>
                            <img :src="`/download/${product.id}/${product.path}`" style="height: auto; width: 80px" />
                        </td>
                        ...
                        <td class="align-middle">
                            ...
                            <button type="button" class="btn btn-outline-success me-1" @click="goToUpdate(product.id)">
                                수정
                            </button>
